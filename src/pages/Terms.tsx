        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8 text-foreground">
              <div>
                <h2 className="text-2xl text-primary mb-4">Acceptance of Terms</h2>
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Service Description</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Medical Disclaimer</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Data Accuracy</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">User Conduct</h2>
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Alert Service Subscription</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Limitation of Liability</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Changes to Terms</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl text-primary mb-4">Contact</h2>
                <p className="text-muted-foreground leading-relaxed">
