    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-background overflow-hidden min-h-[550px] md:min-h-[650px] flex items-end">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/30 md:from-black/60 md:via-black/30 md:to-transparent"></div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-status-accepting flex-shrink-0 mt-0.5" />
                    <span>Choose up to 3 Ontario cities to monitor in your area</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-status-accepting flex-shrink-0 mt-0.5" />
                    <span>Receive email alerts when a clinic's status changes to "Accepting"</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-status-accepting flex-shrink-0 mt-0.5" />
                    <span>Email includes clinic location, contact info, and distance from city center</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-status-accepting flex-shrink-0 mt-0.5" />
              ...
              <div className="text-center">
                <Button size="lg" asChild>
                  <Link href="/pricing">Learn More About Alert Service</Link>
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <div className="mt-4">
                  <Link href="/privacy" className="text-secondary hover:text-primary transition-colors inline-flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-card p-8 rounded-xl shadow-sm border border-border text-center">
              ...
              <Button size="lg" className="w-full" asChild>
                <Link href="/clinics">Start Your Search</Link>
              </Button>
            </div>
